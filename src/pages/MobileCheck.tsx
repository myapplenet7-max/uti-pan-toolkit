export default function MobileCheck() {
  return (
    <div style={{ minHeight: "100vh", background: "#eef1f7", fontFamily: "'Segoe UI', system-ui, sans-serif" }}>
      <div style={{ background: "linear-gradient(135deg, #15233D, #3D5A73)", padding: "16px 20px", display: "flex", alignItems: "center", justifyContent: "space-between" }}>
        <div>
      ...
      <div style={{ maxWidth: 440, margin: "40px auto", padding: "0 16px", textAlign: "center" }}>
        <div style={{ background: "#fff", borderRadius: 18, padding: "40px 24px", boxShadow: "0 4px 24px rgba(0,0,0,0.08)" }}>
          ...
          <h2 style={{ fontSize: 20, fontWeight: 800, color: "#15233D", margin: "0 0 10px" }}>Sign In to View Your Wallet</h2>
          ...
          <a href="/login" style={{ display: "block", padding: "14px", borderRadius: 12, background: "linear-gradient(135deg,#15233D,#3D5A73)", color: "#fff", fontWeight: 800, fontSize: 15, textDecoration: "none", marginBottom: 12 }}>
            🔐 Sign In / Register
          </a>
          <a href="/my-coupons" style={{ display: "block", padding: "13px", borderRadius: 12, background: "#eef1f7", color: "#15233D", fontWeight: 700, fontSize: 14, textDecoration: "none", marginBottom: 12 }}>
            💰 My Coupons (by code/UTR)
          </a>
          <a href="/coupons" style={{ display: "block", padding: "13px", borderRadius: 12, background: "#eef1f7", color: "#15233D", fontWeight: 700, fontSize: 14, textDecoration: "none" }}>
            🎟️ Buy Coupons
          </a>
        </div>
      </div>
